...
This package leans on the `model/query-builder` package for the query building.
...
Migrations are automatically run when refreshing the ModEl Framework cache.
